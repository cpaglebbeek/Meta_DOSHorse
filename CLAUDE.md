...
| DOSHorse_Core | v0.0.5 | Roberts | Ed Roberts (Altair 8800 designer, 1974) — enabled microcomputer-revolutie via werkbaar target-platform; past bij hotfix die Emscripten als DOSHorse-target werkbaar maakt (patches/0002-emscripten-cflags) |
...
| DOSHorse_Web | v0.0.3 | Sutherland | Ivan Sutherland (Sketchpad, 1963) — eerste interactieve computer-graphics; past bij eerste echte dosbox-x WASM-build met DOS-graphics in browser-canvas |
